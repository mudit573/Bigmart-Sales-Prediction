...
def result():
   ...
   # print(item_fat_content)
    ...
    le=joblib.load(r'E:\Udemy ML\project\BigMart Data prediction\le.sav')
...
# Lets put all in the list
    ...
    sc = joblib.load(r'E:\Udemy ML\project\BigMart Data prediction\sc.sav')
    inputs_std= sc.transform(inputs)

    # Lets apply prediction

    model=joblib.load(r'E:\Udemy ML\project\BigMart Data prediction\RandomForest_model.sav')
